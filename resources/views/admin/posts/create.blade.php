...
<div class="max-w-[96%] mx-auto space-y-6">
    <div class="flex items-center gap-4">
        ...
        <h2 class="text-xl font-bold text-gray-800">Write New Article</h2>
    </div>
    ...
    <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="space-y-6 w-full">
            ...
            <div class="bg-white rounded-xl border border-gray-150 shadow-sm p-6 space-y-6">
                <div>
                    ...
                    <input type="text" name="title" id="title" value="{{ old('title') }}" placeholder="e.g. 10 Best Practices for Laravel Developers"
            ...
            <div class="bg-white rounded-xl border border-gray-150 shadow-sm p-6 space-y-6">
                ...
                <div class="pt-2 flex justify-start {{ old('faqs') && count(old('faqs')) > 0 ? '' : 'hidden' }}" id="add-faq-btn-bottom-container">
                ...
                <div id="faq-empty-state" class="text-center py-6 text-gray-400 {{ old('faqs') && count(old('faqs')) > 0 ? 'hidden' : '' }}">
            ...
            <div id="custom-cta-section" class="bg-white rounded-xl border border-gray-150 shadow-sm p-6 space-y-6 {{ $hasCtaPlaceholder ? '' : 'hidden' }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="cta_title" id="cta_title" value="{{ old('cta_title') }}" placeholder="e.g. Start Your Coding & Data Science Journey Today"
                    ...
                    <div>
                        ...
                        <input type="text" name="cta_button_text" id="cta_button_text" value="{{ old('cta_button_text') }}" placeholder="e.g. Find Coding & Data Science Tutors"
                               class="mt-2 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <textarea name="cta_description" id="cta_description" rows="3" placeholder="e.g. Connect with expert mentors who will guide you..."
                                  class="mt-2 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">{{ old('cta_description') }}</textarea>
                    </div>

                    <div>
                        <label for="cta_button_link" class="block text-sm font-semibold text-gray-700">CTA Button Link</label>
                        <input type="text" name="cta_button_link" id="cta_button_link" value="{{ old('cta_button_link') }}" placeholder="e.g. /search/tutors"
                               class="mt-2 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                ...
                <div class="border-t border-gray-100 pt-4 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="cta_directory_title" id="cta_directory_title" value="{{ old('cta_directory_title') }}" placeholder="e.g. Explore Coding & Data Science Tutors by Location"
                                   class="mt-2 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                        </div>

                        <div>
                            <label for="cta_directory_subtitle" class="block text-sm font-semibold text-gray-700">Directory Section Subtitle</label>
                            <input type="text" name="cta_directory_subtitle" id="cta_directory_subtitle" value="{{ old('cta_directory_subtitle') }}" placeholder="e.g. Find Expert programming and data science mentors across India"
                                   class="mt-2 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="text" name="cta_col1_title" id="cta_col1_title" value="{{ old('cta_col1_title') }}" placeholder="e.g. Popular courses"
                                   class="mt-2 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                            ...
                            <textarea name="cta_col1_links" id="cta_col1_links" rows="6" placeholder="Python Programming | /courses/python&#10;Data Science | /courses/data-science"
                                      class="mt-2 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-xs font-mono">{{ old('cta_col1_links') }}</textarea>
                        </div>

                        <div>
                            <label for="cta_col2_title" class="block text-sm font-semibold text-gray-700">Column 2 Title</label>
                            <input type="text" name="cta_col2_title" id="cta_col2_title" value="{{ old('cta_col2_title') }}" placeholder="e.g. Popular Locations"
                                   class="mt-2 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                            ...
                            <textarea name="cta_col2_links" id="cta_col2_links" rows="6" placeholder="Bangalore | /tutors/bangalore&#10;Hyderabad | /tutors/hyderabad"
                                      class="mt-2 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-xs font-mono">{{ old('cta_col2_links') }}</textarea>
                        </div>

                        <div>
                            <label for="cta_col3_title" class="block text-sm font-semibold text-gray-700">Column 3 Title</label>
                            <input type="text" name="cta_col3_title" id="cta_col3_title" value="{{ old('cta_col3_title') }}" placeholder="e.g. Popular Searches"
                                   class="mt-2 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                            ...
                            <textarea name="cta_col3_links" id="cta_col3_links" rows="6" placeholder="Learn Python free | /search?q=python&#10;Data science tutorial | /search?q=ds"
                                      class="mt-2 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-xs font-mono">{{ old('cta_col3_links') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl border border-gray-150 shadow-sm p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div>
                        ...
                        <input type="text" name="meta_title" id="meta_title" value="{{ old('meta_title') }}" placeholder="Defaults to post title if blank"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pt-6">
            ...
            {{-- Publish Widget --}}
            <div class="bg-white rounded-xl border border-gray-150 shadow-sm p-6 space-y-6" x-data="{ status: '{{ old('status', 'draft') }}' }">
                ...
                <div class="space-y-4 pt-4 border-t border-gray-100">
                    ...
                    <label class="flex items-center gap-3">
                        <input type="checkbox" name="allow_comments" value="1" {{ old('allow_comments', 1) ? 'checked' : '' }}
                               class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
            ...
            <div class="bg-white rounded-xl border border-gray-150 shadow-sm p-6 space-y-6">
                ...
                <input type="hidden" name="locale" id="locale" value="{{ old('locale', app()->getLocale()) }}">
                ...
                <div>
                    ...
                    <div class="mt-2 max-h-48 overflow-y-auto border border-gray-200 rounded-lg p-3 space-y-2">
                        ...
                        @empty
                            <p class="text-xs text-gray-400">No tags available.</p>
                        @endforelse
                    </div>
                </div>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const draftKey = 'universal_blog_cms_create_post_draft';
