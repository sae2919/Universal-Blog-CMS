        ...
        <div class="space-y-6">
            <div class="bg-white rounded-xl border border-gray-150 shadow-sm p-6 space-y-6">
                ...
                <div>
                    ...
                    <div id="image-preview-container" x-data="{ hasImage: @json(!!$page->featured_image), removeImage: false }">
                        @if($page->featured_image)
                            <div class="mt-2 mb-2 relative" x-show="hasImage && !removeImage">
                            ...
                            <div x-show="removeImage" class="mt-2 text-xs text-red-650 font-semibold mb-2" style="display: none;">
