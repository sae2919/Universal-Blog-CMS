...
@section('title', 'Create Menu Location')
@section('header', 'New Menu Location')

@section('content')
<div class="max-w-2xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        <h3 class="text-lg font-bold text-gray-800 dark:text-slate-200">Create Menu Location</h3>
    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl border border-gray-150 dark:border-slate-700 shadow-sm p-6">
        <form action="{{ route('admin.menus.store') }}" method="POST" class="space-y-6">
            ...
            <div class="space-y-2">
                ...
                <input type="text" name="name" id="name" required placeholder="e.g. Main Navigation Menu" value="{{ old('name') }}"
            ...
            <div class="space-y-2">
                ...
                <input type="text" name="location" id="location" required placeholder="e.g. main, footer" value="{{ old('location') }}"
